import{p as l}from"./chunk-JZWAC4HX-Ct9RjdWh.js";import{v as r}from"./gql-C25LTheC.js";const m="/".replace(/\/$/,""),u=`${m}/`,P=500,y=/^([a-z][a-z\d+\-.]*:)?\/\//i,_=({src:e,...a})=>{const s=y.test(e)?e:`${u}${e.startsWith("/")?e.slice(1):e}`;return l.jsx("img",{src:s,...a})};r(`
...
`),t={all:["proposals"],lists:()=>[...t.all,"list"],list:e=>[...t.lists(),{filters:e}],paginated:(e,a)=>[...t.lists(),"paginated",{where:e,year:a}],details:()=>[...t.all,"detail"],detail:e=>[...t.details(),e],years:()=>[...t.all,"years"]},h={all:["proposals"],lists:()=>[...t.all,"list"],list:e=>[...t.lists(),{filters:e}],paginated:(e,a,i,s,d)=>[...t.lists(),"paginated",{page:e,pageSize:a,sort:i,where:s,year:d}],details:()=>[...t.all,"detail"],detail:e=>[...t.details(),e],years:()=>[...t.all,"years"]},R=r(`
...
`);export{U as G,_ as I,u as S,b as U,I as a,o as b,R as c,P as d,T as e,h as f,G as g,S as h,A as i,n as j,E as k,p as l,t as p};
