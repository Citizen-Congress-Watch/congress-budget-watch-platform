import{t as l}from"./chunk-QUQL4437-Ce7C6B2x.js";import{g as r}from"./gql-j8MyrNkb.js";const m="/".replace(/\/$/,""),u=`${m}/`,P=500,y=/^([a-z][a-z\d+\-.]*:)?\/\//i,_=({src:e,...a})=>{const s=y.test(e)?e:`${u}${e.startsWith("/")?e.slice(1):e}`;return l.jsx("img",{src:s,...a})};r(`
...
`);export{U as G,_ as I,P as S,b as U,A as a,I as b,R as c,E as d,S as e,T as f,G as g,u as h,o as i,n as j,t as k,h as l,p};
